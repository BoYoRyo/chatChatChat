    ...
    <form method="POST" action={{ route('sendtalk.store') }}>
        ...
        <div class="container mx-auto flex-center m-4 w-1/2 py-4 px-8 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
            <div class="py-4 px-8 bg-white rounded dark:bg-gray-800">
                ...
                <textarea id="comment" rows="4" class="px-0 w-full text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-black dark:placeholder-gray-400" placeholder="トークを開始する"></textarea>
            </div>
