    ...
    @else
        @foreach ($group->conversation as $conversation)
            @if ($conversation->user_id == Auth::id())
                {{-- ユーザー側のコメント --}}
                <<<<<<< HEAD <div class="container mx-auto  w-1/2 py-4 text-right rounded-2xl flex flex-row-reverse">
                    <div
                        ...
                        @if ($group->type == '1')
                            <div>
                                ...
                                <div
                                    ...
                                    {{ $conversation->comment }}
                                    @if ($conversation->image != null)
                                        <img src={{ asset('storage/img/' . $conversation->image) }}
                                            style="width:150px;">
                                    @endif
                                </div>
                            </div>
